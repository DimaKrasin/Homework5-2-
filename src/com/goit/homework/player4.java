...
public class player4 extends SuperPlayer {
    ...
    public void playLastSong(String[] songs){
    ...
    public void start(Stage stage,String song,String[] songs) {
        ...
        btn4.setOnAction(event -> {
            root.getChildren().add(CreateLabel(50,260,songs[songs.length-1].toString()));
        });
        ...
        root.getChildren().addAll(
                ...
                CreateLabel(60,btn4.getTranslateY(),"Проиграть последнию песню"),
                btn1,
                btn2,
                btn3,
                btn4
